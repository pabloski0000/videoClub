...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $p = new Movie;
        self::seedCatalog();
        $this->command->info('Tabla caatálogo inicializada con datos!');
    ...
    private static function seedCatalog(){
        ...
        foreach(self::$arrayPeliculas as $pelicula){
            $modelo = new Movie();
            $modelo->title = $pelicula['title'];
            $modelo->year = $pelicula['year'];
            $modelo->director = $pelicula['director'];
            $modelo->poster = $pelicula['poster'];
            $modelo->rented = $pelicula['rented'];
            $modelo->synopsis = $pelicula['synopsis'];
            $modelo->save();
        }
    }
}
